# STATE -> like keep a memory for particular item (which is supposed to be certain format)
...
class Plan(BaseModel):
    ...
    description: str = Field(description="A description of the app to be built, e.g. 'A web application for managing personal finances'")
...
class TaskPlan(BaseModel):
    ...
    # ConfigDict let's you add extra element
